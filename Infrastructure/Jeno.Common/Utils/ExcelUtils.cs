...
namespace Jeno.Common.Utils
{
    ...
    public class ExcelUtils
    {
        ...
        MemoryStream ExportDT(DataTable dtSource, string strHeaderText)
        {
        ...
        /// <param name="dtSource">源DataTable</param>
        /// <param name="strHeaderText">表头文本</param>
        void ExportDTI(DataTable dtSource, string strHeaderText, FileStream fs)
        {
        ...
        public void ExportDTtoExcel(DataTable dtSource, string strHeaderText, string strFileName)
        {
        ...
        public DataTable ImportExceltoDt(Stream stream)
        {
            try
            {
                DataTable dt = new DataTable();
        ...
        public DataTable ImportExceltoDt(Stream stream, string sheetName, int HeaderRowIndex)
        {
            try
            {
                DataTable dt = new DataTable();
        ...
        public DataSet ImportExceltoDs(Stream stream)
        {
            try
            {
        ...
        /// <returns>Excel中的数据</returns>
        public DataSet ImportExceltoDs(Stream stream, Dictionary<string, int> dict)
        {
            try
            {
                DataSet ds = new DataSet();
        ...
        /// <param name="HeaderRowIndex">列头所在行号，-1表示没有列头</param>
        /// <returns></returns>
        DataTable ImportDt(ISheet sheet, int HeaderRowIndex, bool needHeader)
        {
            DataTable table = new DataTable();
            IRow headerRow;
            int cellCount;
        ...
        public void InsertSheet(string outputFile, string sheetname, DataTable dt)
        {
        ...
        public void UpdateExcel(string outputFile, string sheetname, string[] updateData, int coluid, int rowid)
        {
            //FileStream readfile = new FileStream(outputFile, FileMode.Open, FileAccess.Read);
        ...
        /// <param name="rowid">需更新的开始行号</param>
        public void UpdateExcel(string outputFile, string sheetname, string[][] updateData, int[] coluids, int rowid)
        {
            FileStream readfile = new FileStream(outputFile, FileMode.Open, FileAccess.Read);
        ...
        /// <param name="coluid">需更新的列号</param>
        /// <param name="rowid">需更新的开始行号</param>
        public void UpdateExcel(string outputFile, string sheetname, double[] updateData, int coluid, int rowid)
        {
            FileStream readfile = new FileStream(outputFile, FileMode.Open, FileAccess.Read);
        ...
        /// <param name="coluids">需更新的列号</param>
        /// <param name="rowid">需更新的开始行号</param>
        public void UpdateExcel(string outputFile, string sheetname, double[][] updateData, int[] coluids, int rowid)
        {
            FileStream readfile = new FileStream(outputFile, FileMode.Open, FileAccess.Read);
        ...
        public ArrayList GetSheetName(string outputFile)
        {
        ...
        {
            global::System.Text.RegularExpressions.Regex rex = new global::System.Text.RegularExpressions.Regex(@"^[-]?\d+[.]?\d*$");
            result = -1;
        ...
        public void ExportByWeb(DataTable dtSource, HttpContext curContext, string strHeaderText, string strFileName)
        {
            // 设置编码和附件格式
            //curContext.Response.ContentType = "application/vnd.ms-excel";
            //curContext.Response.StatusCode = Encoding.UTF8;
        ...
        public void ExportByWeb(DataSet ds, string strHeaderText, string strFileName)
        {
